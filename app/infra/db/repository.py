...
from app.domain.models import Inference, OCRDocument
from app.domain.ports import InferenceRepository, OCRDocumentRepository
from app.infra.db.tables import InferenceTable, OCRDocumentTable
